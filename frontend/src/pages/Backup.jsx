                ...
                <SectionCard title="Export Backup" icon={<Download />} accent="emerald">
                    ...
                    <div className="bg-zinc-900/60 rounded-xl p-4 mb-5 border border-white/5">
                        ...
                        <div className="space-y-1.5">
                            {['config.json', 'client_secret.json', 'sheets_client_secret.json', 'service_account.json', '.env', 'viewers.db', 'subscriber_count.json', 'data/donations.json', 'data/brain.db', 'data/youtube_memory.db'].map(f => (
